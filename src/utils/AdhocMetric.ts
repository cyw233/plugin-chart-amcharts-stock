 ...
 * under the License.
 */
export interface AdhocMetricProps {
...
function inferSqlExpressionColumn(adhocMetric: any) {
  if (
...
function inferSqlExpressionAggregate(adhocMetric: any) {
  if (
    adhocMetric.sqlExpression &&
    sqlaAutoGeneratedMetricRegex.test(adhocMetric.sqlExpression)
  ) {
...
export default class AdhocMetric {
  ...
  equals(adhocMetric: AdhocMetricProps) {
    return (
